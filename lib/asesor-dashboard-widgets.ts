import {
  CircleDollarSign, Receipt, Wallet, TrendingUp,
  Users, AlertTriangle, Activity, BarChart3
} from "lucide-react";

export const ALL_ASESOR_DASHBOARD_WIDGETS = [
  { id: "seccion_mi_asesoria", label: "Mi Asesoria", icon: CircleDollarSign, description: "KPIs financieros propios: facturacion, gastos, beneficio y YTD." },
