...
const AEAT_LINKS: Record<string, ModelLinks> = {
  "303": {
    presentar: "https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI34.shtml",
    consultar: "https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI01.shtml",
