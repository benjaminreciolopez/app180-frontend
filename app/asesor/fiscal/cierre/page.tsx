...
import {
    ...
    ArrowRightLeft, DoorOpen, Building2
} from "lucide-react";
...
export default function AsesorCierreEjercicioPage() {
        ...
        async function loadClientes() {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    setClientes(list.map((c: any) => ({ empresa_id: c.empresa_id, nombre: c.nombre || c.empresa_nombre || "Sin nombre" })));
                    if (list.length > 0) {
                        // Check sessionStorage for pre-selected client
    ...
    const basePath = selectedEmpresa ? `/asesor/clientes/${selectedEmpresa}/fiscal/cierre` : "";
    ...
    }, [ejercicio, selectedEmpresa, basePath]);
    ...
    }, [ejercicio, selectedEmpresa, loadCierre, loadLog]);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                        Proceso de cierre fiscal del ejercicio para tus clientes.
                    </p>
                </div>
            ...
            {!selectedEmpresa && (
                <Card>
                    <CardContent className="pt-6 text-center text-muted-foreground">
                        Selecciona un cliente para ver su cierre de ejercicio.
                    </CardContent>
                </Card>
            )}
            ...
            {!loading && cierre && selectedEmpresa && (
                <>
                    {/* Progress Bar */}
                    <Card>
