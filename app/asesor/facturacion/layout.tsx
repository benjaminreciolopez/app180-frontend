  ...
  const tabs = [
    {
      label: "Dashboard",
      icon: BarChart3,
      href: "/asesor/facturacion/dashboard",
      active: pathname.includes("/dashboard"),
    },
    {
      label: "Facturas",
      icon: FileText,
      href: "/asesor/facturacion/listado",
      active: pathname.includes("/listado") || pathname.includes("/proformas") || pathname === "/asesor/facturacion",
    },
    {
      label: "Conceptos",
      icon: BookOpen,
      href: "/asesor/facturacion/conceptos",
      active: pathname.includes("/conceptos"),
    },
    {
      label: "Informes",
      icon: PieChart,
      href: "/asesor/facturacion/informes",
      active: pathname.includes("/informes"),
    },
    {
      label: "Auditoría Veri*Factu",
      icon: ShieldCheck,
      href: "/asesor/facturacion/auditoria",
      active: pathname.includes("/auditoria"),
    },
    {
      label: "Almacenamiento",
      icon: HardDrive,
      href: "/asesor/facturacion/almacenamiento",
    ...
    <div className="flex flex-col h-full bg-slate-50/50">
      ...
      <header className="border-b bg-white px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <div className="flex items-center gap-2">
          <Button
            onClick={() => router.push("/asesor/facturacion/crear")}
