                            ...
                            <div className="w-full md:w-[400px] space-y-4">
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Select
                                            value={String(retencionPorcentaje)}
                                            onValueChange={(val) => setRetencionPorcentaje(Number(val))}
                                        >
                                            <SelectTrigger className="w-full bg-white border-slate-200">
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="1">1% (Módulos)</SelectItem>
                                                <SelectItem value="7">7% (Nuevos Prof.)</SelectItem>
                                                <SelectItem value="15">15% (Profesionales)</SelectItem>
                                                <SelectItem value="19">19% (Alquileres)</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </div>
